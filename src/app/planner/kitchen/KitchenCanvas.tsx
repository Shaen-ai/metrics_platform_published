...
function KitchenRoom({ totalWidthCm, leftWallDepthCm = 0 }: { totalWidthCm: number; leftWallDepthCm?: number }) {
  ...
  const polyWallMatByEdge = useMemo(() => {
    ...
    kitchenRoom.wallTextureWidthCm,
    kitchenRoom.wallTextureHeightCm,
    kitchenRoom.wallMaterialProductWidthCm,
    kitchenRoom.wallMaterialProductHeightCm,
    kitchenRoom.wallTileWidthCm,
    kitchenRoom.wallTileHeightCm,
    kitchenRoom.wallTileGroutCm,
    kitchenRoom.wallTileGroutColor,
    RW,
    RD,
    RH,
    invalidate,
