 ...
 * CSG wall geometries intentionally omit UVs while boolean cuts are evaluated; this restores
 * them afterwards so catalog wallpaper and tile textures have coordinates to sample.
 */
